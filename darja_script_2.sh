...
hmmix train -obs=obs.HG00451.txt -weights=strictmask.bed -mutrates=mutrate.bed -out=trained.HG00451.phased.json -haploid

hmmix decode -obs=obs.HG00451.txt -weights=strictmask.bed -mutrates=mutrate.bed -param=trained.HG00451.phased.json -out=HG00451.decoded -haploid 